...
class TestV1ProductionEndpoints:
    ...
    def test_era5_production_all(self):
        ...
        response = client.get(
            "/api/v1/era5/production?lat=40.0&lng=-70.0&height=40&powercurve=nlr-reference-100kW&period=all"
        )
        assert response.status_code == 200
        json = response.json()
    ...
    def test_era5_production_summary(self):
        ...
        response = client.get(
            "/api/v1/era5/production?lat=40.0&lng=-70.0&height=40&powercurve=nlr-reference-100kW&period=summary"
        )
        assert response.status_code == 200
        json = response.json()
    ...
    def test_era5_production_annual(self):
        ...
        response = client.get(
            "/api/v1/era5/production?lat=40.0&lng=-70.0&height=40&powercurve=nlr-reference-100kW&period=annual"
        )
        assert response.status_code == 200
        json = response.json()
    ...
    def test_era5_production_full(self):
        ...
        response = client.get(
            "/api/v1/era5/production?lat=40.0&lng=-70.0&height=40&powercurve=nlr-reference-100kW&period=full"
        )
        assert response.status_code == 200
        json = response.json()
        assert "energy_production" in json
    ...
    def test_wtk_production(self):
        """Test WTK production."""
        response = client.get(
            "/api/v1/wtk/production?lat=40.0&lng=-100.0&height=80&powercurve=nlr-reference-100kW&period=all"
        )
        assert response.status_code == 200
        json = response.json()
        assert "energy_production" in json
    ...
    def test_ensemble_production(self):
        ...
        response = client.get(
            "/api/v1/ensemble/production?lat=40.0&lng=-70.0&height=40&powercurve=nlr-reference-100kW&period=all"
        )
        assert response.status_code == 200
        json = response.json()
        assert "energy_production" in json
    ...
    def test_production_invalid_powercurve(self):
        ...
        response = client.get(
            "/api/v1/era5/production?lat=40.0&lng=-70.0&height=40&powercurve=invalid-curve&period=all"
        )
        assert response.status_code == 400
