...
def get_windrose(
    ...
    bin: int = Query(
        5,
        description="Speed band count per sector. 0 = raw mode: returns the individual wind speed values for each sector. 2–10 = binned mode: divides the wind speed range (0 to site max) into this many equal-width bands and returns the fraction of hours in each band per sector. Default: 5.",
    ),
